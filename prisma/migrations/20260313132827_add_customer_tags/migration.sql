...
INSERT INTO "new_HourPackage" ("accessToken", "createdAt", "customerAddress", "customerEmail", "customerId", "customerName", "expiresAt", "hoursTotal", "hoursUsed", "id", "orderId", "orderName", "productId", "productTitle", "purchasedAt", "shop", "updatedAt") SELECT "accessToken", "createdAt", "customerAddress", "customerEmail", "customerId", "customerName", "expiresAt", "hoursTotal", "hoursUsed", "id", "orderId", "orderName", "productId", "productTitle", "purchasedAt", "shop", "updatedAt" FROM "HourPackage";
